...
"""autogenerated by genpy from ros_action/ros_actionActionResult.msg. Do not edit."""
import codecs
import sys
...
class ros_actionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "ros_action/ros_actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_action/ros_actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ros_actionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ros_action.msg.ros_actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ros_action.msg.ros_actionResult()
