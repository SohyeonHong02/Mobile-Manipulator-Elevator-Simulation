...
let ros_actionGoal = require('./ros_actionGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class ros_actionActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ros_actionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ros_actionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ros_actionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ros_actionGoal()
    }
...
module.exports = ros_actionActionGoal;
